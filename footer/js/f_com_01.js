...
// main page : 파트너사 동작 구현 (ScrollMagic 라이브러리 사용)
const fadeInEls = document.querySelectorAll('div.fade-in');

fadeInEls.forEach(function (fadeInEl) {
  new ScrollMagic.Scene({
    triggerElement: fadeInEl, // y value not modified, so we can use element as trigger as well
    triggerHook: 0.6,
  })
  .setClassToggle(fadeInEl, "show") // add class toggle
